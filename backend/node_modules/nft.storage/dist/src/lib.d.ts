export type AnyBlockDecoder = import('multiformats/block').BlockDecoder<any, any>;
...
export class NFTStorage implements API.Service {
     ...
     * @returns {Promise<API.CIDString>}
     */
    static storeCar({ endpoint, token }: API.Service, car: Blob | API.CarReader, { onStoredChunk, decoders }?: {
        onStoredChunk?: ((size: number) => void) | undefined;
        decoders?: import("multiformats/codecs/interface").BlockDecoder<any, any>[] | undefined;
